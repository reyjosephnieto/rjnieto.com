---
title: "Hobby"
subtitle: "Independent mathematics, AI, and machine-learning research"
description: "RJ Nieto's hobby is independent mathematics, artificial intelligence, and machine-learning research."
image: "/assets/images/research/diabetic-retinopathy-visual-field.webp"
image-alt: "A clear view of children playing football beside a blurred and obscured view representing possible sight loss"
canonical-url: "https://rjnieto.com/research/"
header-includes: |
  <meta name="robots" content="index, follow, max-image-preview:large">
  <meta property="og:url" content="https://rjnieto.com/research/">
  <meta property="og:type" content="article">
toc: true
toc-depth: 2
---

My hobby is independent mathematics, artificial intelligence, and
machine-learning research. My current project asks a practical question: when
an image is blurred, rotated, resized, poorly exposed, or corrupted by sensor
noise, how does the information extracted by a computer change? I want to
understand whether the pattern of those changes can help identify what went
wrong during acquisition. This project continues the work begun in my
University of Bristol final-year dissertation.

## Retinal imaging and diabetic retinopathy
...
::: {#fig-dr-visual-field}
![](../assets/images/research/diabetic-retinopathy-visual-field.webp){fig-alt="Two illustrated views of the same children playing football in a park, as if seen by a parent. The first is clear. The second is blurred and partly obscured by soft dark patches and floaters to suggest one possible experience of sight loss associated with advanced diabetic retinopathy." width=1536 height=1024 style="width:100%"}
...
The NHS Diabetic Eye Screening Programme offers a practical setting for this
question. Fundus photographs are assessed against defined
...
![](../assets/images/research/fives-214d-blobs-loops.webp){fig-alt="A colour retinal fundus photograph with two boxed regions enlarged alongside it. One enlargement marks a red lesion as a connected blob; the other marks several loops in the retinal vasculature." width=900 height=439 style="width:92%" loading="lazy" decoding="async"}
...
::: {#fig-grid-shattering}
![](../assets/images/research/grid-shattering-abstract.webp){fig-alt="Four-panel schematic of a continuous retinal vascular loop and its sampled pixel representation. When aligned, the sampled pixels retain an intact loop. After a slight rotation and resampling, the same underlying vascular structure becomes fragmented on the pixel grid." width=1254 height=1254 style="width:100%" loading="lazy" decoding="async"}
...
### Questions left by the dissertation
