---
title: "Functoriality and Triangulation"
subtitle: "Why the computational pipeline preserves structure"
description-meta: "Categories, chain and homology functors, CFK triangulation, filtered complexes, and the functorial stability argument."
...
::: {.callout-important title="Optional second pass"}
The computational course is complete without this material. The purpose here
is to show that the maps used throughout the notes fit together coherently and
that the cubical theory connects to the standard simplicial theory.
