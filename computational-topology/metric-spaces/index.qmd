...
description: "A first-principles introduction to metrics, open balls, continuity, and the supremum distance used in computational topology."
...
that produced them. This is our first move from geometry toward topology:
...
7. Suppose two grayscale images have intensities in $[0,255]$. What is the
