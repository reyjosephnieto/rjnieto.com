...
description-meta: "Graphs, connectivity, image grids, threshold sets, and the discrete structures underlying cubical topology."
...
Graphs settle adjacency and thresholding, but they do not by themselves
distinguish a filled cycle from a hole. That distinction requires pixels to be
treated as filled squares in a cubical complex.
:::
...
be a finite set of pixel coordinates. A greyscale digital image is a pair
$(\Omega,I)$, where
